...
extern Uint16 Spia_xmit(Uint16 a);
extern void Spib_init(void);
...
extern void User_InitADC(void);
extern void User_AdcOffset(void);
...
extern Uint16 g_iRefreshCount;
extern Uint16 g_iSendStateCount;
extern Uint16 g_bNewCommandArrived;

extern Uint16 iRevData;
extern Uint16 g_iRecvCount;
extern Uint16 g_iSendCount;
extern Uint16 g_bSendFlag;
extern Uint16 iChecksum;
extern Uint16 g_iPosCnt;
extern Uint16 TimeSequence;
extern Uint16 g_iNewDataTimeCount;
extern Uint16 g_iEPwmTZIntCount;

extern Uint16 g_iMotorTemp;          // 温度采样，单位:摄氏度
extern Uint16 g_iDriverTemp;          // 温度采样，单位:摄氏度

extern float g_iMeaDCVoltage;          //  母线电压
extern float errVel;
extern float g_iPosRef;

extern Uint16 g_iMotorTempOffset;          // 温度采样，单位:摄氏度
extern Uint16 g_iDriverTempOffset;          // 温度采样，单位:摄氏度
extern Uint16 g_iMeaDCVoltageOffset;          // 母线电压
